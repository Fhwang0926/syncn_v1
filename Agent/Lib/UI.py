...
class syncNTray(QtWidgets.QSystemTrayIcon):
    ...
    def __init__(self, icon, parent=None):
        ...
        self.syncNoteAction = QtWidgets.QAction("Sync Stick Note", self, checkable=True)
        self.syncNoteAction.setStatusTip('Default Yes')
        self.syncNoteAction.setChecked(True)
        menu.addAction(self.syncNoteAction)
